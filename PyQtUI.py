...
"}\n"
"")
        self.frame_filtro.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.frame_res_2.setFrameShape(QtWidgets.QFrame.NoFrame)
...
"}")
        ...
        spacerItem = QtWidgets.QSpacerItem(587, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"- Visualización de datos: Herramientas como PyQt5 para apoyar la toma de decisiones informadas."))
        ...
        self.sierra.setText(_translate("MainWindow", "Sierra"))
