...
"")
        ...
        self.bt_limpiar.setGeometry(QtCore.QRect(20, 330, 120, 30))
        ...
        self.anio.setGeometry(QtCore.QRect(10, 280, 91, 49))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.anio_box.setGeometry(QtCore.QRect(80, 290, 81, 20))
        ...
        self.departamento.setGeometry(QtCore.QRect(10, 240, 141, 49))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.departamento_box.setGeometry(QtCore.QRect(140, 250, 81, 20))
        self.departamento_box.setObjectName("departamento_box")
        self.departamento_box.addItem("")
        self.rural = QtWidgets.QCheckBox(self.frame_filtro)
        self.rural.setGeometry(QtCore.QRect(30, 200, 80, 17))
        self.rural.setObjectName("rural")
        self.tipo_poblacion = QtWidgets.QPlainTextEdit(self.frame_filtro)
        self.tipo_poblacion.setGeometry(QtCore.QRect(10, 160, 161, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        self.tipo_poblacion.setFont(font)
        self.tipo_poblacion.setObjectName("tipo_poblacion")
        self.urbana = QtWidgets.QCheckBox(self.frame_filtro)
        self.urbana.setGeometry(QtCore.QRect(30, 220, 80, 17))
        self.urbana.setObjectName("urbana")
        self.tipo_poblacion.raise_()
        self.bt_view.raise_()
        self.bt_limpiar.raise_()
        self.region.raise_()
        self.bt_ejecutar.raise_()
        self.anio.raise_()
        self.anio_box.raise_()
        self.costa.raise_()
        self.sierra.raise_()
        self.selva.raise_()
        self.departamento.raise_()
        self.departamento_box.raise_()
        self.rural.raise_()
        self.urbana.raise_()
        self.frame_grafc = QtWidgets.QFrame(self.page_2)
        self.frame_grafc.setGeometry(QtCore.QRect(260, 210, 301, 231))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 40, 281, 181))
        ...
        self.frame_res_2.setGeometry(QtCore.QRect(270, 40, 291, 161))
        ...
        self.text_res.setGeometry(QtCore.QRect(10, 10, 261, 141))
...
"- Visualización de datos: Herramientas como PyQt5 para apoyar la toma de decisiones informadas."))
        ...
        self.anio_box.setItemText(0, _translate("MainWindow", "Todos"))
        ...
        self.departamento_box.setItemText(0, _translate("MainWindow", "Todos"))
        self.rural.setText(_translate("MainWindow", "Rural"))
        self.tipo_poblacion.setPlainText(_translate("MainWindow", "Tipo de Población:"))
        self.urbana.setText(_translate("MainWindow", "Urbana"))
